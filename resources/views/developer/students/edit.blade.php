        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('developer.students.index') }}" class="text-gray-600 hover:text-gray-900">← Kembali</a>
                </div>
                
                <form action="{{ route('developer.students.update', $student->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex justify-end space-x-3 mt-6">
                        <a href="{{ route('developer.students.index') }}" class="px-4 py-2 border rounded-lg text-gray-700 hover:bg-gray-50">Batal</a>
                        <button type="submit" class="px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700">Update Mahasiswa</button>
                    </div>
                </form>
            </div>
        </div>
