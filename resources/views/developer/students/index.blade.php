        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('developer.students.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition">
                        + Tambah Mahasiswa
                    </a>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr data-group-id="{{ $student->group_id }}">
                                ...
                                <td class="px-6 py-4 text-sm space-x-2">
                                    <a href="{{ route('developer.students.edit', $student->id) }}" class="text-yellow-600 hover:text-yellow-900">✏️ Edit</a>
                                    <form action="{{ route('developer.students.destroy', $student->id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin hapus mahasiswa ini?')">
                                        @csrf
                                        @method('DELETE')
